// This is shape_area_functions_3.cpp
// Changes from shape_area_functions_2.cpp:
// validate each substring to be numerical values with stod()
// add additional line "abcd" to your input.txt to test
