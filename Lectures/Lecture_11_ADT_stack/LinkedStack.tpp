...
// TODO: based on the implementation of push(), where is the the newEntry added at the linked chain?
// At the beginning of the linked chain or the end of the linked chain?
// And explain why such a choice is made?
